...
GA4 = [("2026-09-09",1007,19,774700),("2026-09-10",1313,13,585300),("2026-09-11",1178,12,505340),
 ...
 ("2026-09-21",753,5,182560),("2026-09-22",1041,13,1355820),
 ("2026-09-23",287,3,236300)]
BASE_N = 12
DAILY = [   # (날짜, 캠페인, 노출, 클릭, 비용, 전환, 전환값)
 ("2026-09-22", "붓기",       667, 9, 15785, 0, 0),
 ("2026-09-22", "칼륨",        10, 0,     0, 0, 0),
 ("2026-09-22", "브랜드 방어",   2, 0,     0, 0, 0),
 ("2026-09-23", "붓기",       653, 8, 12626, 0, 0),
 ("2026-09-23", "칼륨",        32, 0,     0, 0, 0),
 ("2026-09-23", "브랜드 방어",   5, 1,   889, 0, 0),
]
...
TODO = [
 ...
 ("위험", "확장검색이 정보 검색을 대량으로 끌어옴 — 구조 결정 필요",
  "붓기 캠페인 노출 1,320건 중 상위가 <b>「붓기 빨리 빼는 법」171회 · 「붓기 빼는 법」93회</b>로 "
  "전부 <b>정보 검색</b>입니다. 과금된 11클릭 28,300원도 대부분 여기서 나왔고 전환은 0입니다. "
  "제외 키워드 40개로 1차 방어했지만, 근본 해결은 <b>확장검색 2건(붓기 영양제·붓기 칼륨) 중지</b>와 "
  "<b>정보형 키워드(붓기 빼는 법·붓기 제거·붓기 차) 제거</b>입니다. 캠페인 구조 변경이라 대표님 결정이 필요합니다."),
 ("주의", "심의 비승인 가능 문안 2종",
...
SETUP = [
 ...
 "캠페인 3 · 광고그룹 3 · 광고 3 · 키워드 42 · 제외 키워드 92 · 광고 확장 30 · 위치 · 언어 · 입찰을 모두 API로 설정했습니다.",
...
# ── 알림 ──
w('<div class="note"><span class="ic">!</span><div>'
  '<p><b>이틀치 실적이 들어왔습니다. 그런데 광고비가 새고 있었습니다.</b> '
  '검색어 보고서를 보니 과금된 클릭 11건이 거의 전부 <b>정보 검색</b>이었습니다 — '
  '「붓기 빼는 약」「붓기에 좋은 음식」「호박차 추천」처럼 제품을 살 의도가 없는 검색입니다. '
  '9/23 제외 키워드 40개를 추가해 막았습니다(총 71개). '
  '전환 0은 GA4 가져오기 지연(24~48시간) 때문일 수도 있으니 아직 단정하지 않습니다.</p></div></div>\n')
...
for short, full, cid, bud, ceil, nkw, why in CAMPAIGNS:
    ...
    w('<td class="num">제목 15<br>설명 4</td>')
    w('</tr>')
...
w('<section><div class="sec-h"><h2>광고 켜기 전 기준선</h2>'
  '<span class="sec-n">GA4 · 2026-09-09 ~ 09-22</span></div>')
...
# ── 5. 제외 키워드 ──
w('<section><div class="sec-h"><h2>제외 키워드 92개</h2>'
  '<span class="sec-n">캠페인 레벨 · 31단어 × 3캠페인 (브랜드는 30)</span></div>')
...
w('<section><div class="sec-h"><h2>광고 문안</h2>'
  '<span class="sec-n">광고 제목 45 + 설명 12 · 한도 초과 0건</span></div>')
...
for short, *_ in CAMPAIGNS:
    w(f'<div class="cgrp"><h3>{e(short)} <em>제목 15 · 설명 4</em></h3><div class="lines">')
