...
TODO = [
 ...
 ("주의", "확장검색 3건 감시",
  "<b>붓기 영양제 · 붓기 칼륨 · 칼륨 영양제</b>가 확장검색입니다. 관련 검색까지 폭넓게 받으니 "
  "예산이 새기 쉽습니다. 내일 검색어 보고서를 보고 엉뚱한 검색은 제외 키워드로 막습니다."),
 ("주의", "심의 비승인 가능 문안 2종",
...
def revenue_chart():
    ...
    for i, (d, s, t, v) in enumerate(GA4):
        ...
        if d == "2026-09-22": cls = "bar partbar"
...
w('<div class="note"><span class="ic">!</span><div>'
  '<p><b>오늘 켰습니다.</b> 그래서 실적 표가 비어 있는 게 정상입니다. '
  '구글 심의가 통과되면 노출이 시작되고, 전환은 GA4에서 가져오는 방식이라 '
  '<b>24~48시간 늦게</b> 들어옵니다. 첫 이틀은 <b>비용은 있는데 전환이 0</b>으로 보일 수 있습니다. '
  '3~4일차부터 판단하세요.</p></div></div>\n')
...
w('<div class="legend">'
  ...
  '<span><i style="background:var(--line-2)"></i>9/22 집계 진행 중</span>'
  '</div></div>')
