...
GA4 = [("2026-09-09",1007,19,774700),("2026-09-10",1313,13,585300),("2026-09-11",1178,12,505340),
 ...
 ("2026-09-23",988,7,690900),("2026-09-24",241,3,286800)]
BASE_N = 12
...
SETUP = [
 ...
 "캠페인 3 · 광고그룹 3 · 광고 3 · 키워드 42 · 제외 키워드 102+ · 광고 확장 30 · 위치 · 언어 · 입찰을 모두 API로 설정했습니다.",
...
w('<div class="note"><span class="ic">!</span><div>'
  '<p><b>9/23 실적이 확정됐습니다. 노출 1,269 · 클릭 21 · 비용 30,408원 · 전환 0.</b> '
  '같은 날 GA4 매출은 <b>690,900원</b>으로 광고 전 기준선(149만원)의 <b>46%</b>였습니다. '
  '이틀 연속 매출이 기준선을 밑돌지는 않았지만(9/22는 155만원) 아직 광고가 매출을 밀어올린 흔적은 없습니다. '
  '제외 키워드는 <b>작동을 확인했습니다</b> — 9/23에 음식·약·호박 검색어로 7,831원이 나갔는데 9/24에는 0건입니다. '
  '남은 누수는 우리가 직접 고른 <b>「붓기 차」·「붓기 빼는 법」</b>에서 나옵니다. 아래 「지금 손봐야 할 것」을 보세요.</p></div></div>\n')
...
w('<section><div class="sec-h"><h2>광고 켜기 전 기준선</h2>'
  '<span class="sec-n">GA4 · 2026-09-09 ~ 09-24</span></div>')
...
# ── 5. 제외 키워드 ──
w('<section><div class="sec-h"><h2>제외 키워드 102+개</h2>'
  '<span class="sec-n">캠페인 레벨 · 붓기 102 · 칼륨 31 · 브랜드 30</span></div>')
